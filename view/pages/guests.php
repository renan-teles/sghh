                                    ...
                                    <div class="col-md-6 text-center text-md-end mb-3 mb-md-0">
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul id="filtersDropdownMenu" class="dropdown-menu">
                                                <li><button id="filterName" class="btn btnAddFilter w-100" type='button'>Nome</button></li>
                                                <li><button id="filterEmail" class="btn btnAddFilter w-100" type='button'>Email</button></li>
                                                <li><button id="filterCPF" class="btn btnAddFilter w-100" type='button'>CPF</button></li>
                                                <li><button id="filterCPFResposible" class="btn btnAddFilter w-100" type='button'>CPF do Responsável</button></li>
                                                <li><button id="filterTelephone" class="btn btnAddFilter w-100" type='button'>Telefone</button></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-12 mt-4">
                ...
                <table class="table text-center align-middle table-sm table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr id='tr_<?=$g["id"];?>'>
                                <th scope='row' id='nameGuest'><?=$g["name"];?></th>
                                <td id='emailGuest'><?=$g["email"];?></td>
                                <td id='cpfGuest'><?=formatCPF($g["cpf"]);?></td>
                                <td id='cpfResponsibleGuest'><?=formatCPF($g["cpf_responsible"]);?></td>
                                <td id='telephoneGuest'><?=formatTelephone($g["telephone"]);?></td>
                                <td id='dateBirthGuest'><?=date("d/m/Y", strtotime($g["date_birth"]));?></td>
                                <td>
                                    <button id='tr_<?=$g["id"];?>' class='btn btn-secondary btn-sm btn btnOpenModalEdit my-1 my-sm-0' type='button' data-bs-target='#modalEditGuest' data-bs-toggle='modal'><i id='tr_<?=$g["id"];?>' class='bi-pencil-fill'></i></button>
                                    <button id='tr_<?=$g["id"];?>' class='btn btn-danger btn-sm btnOpenModalDelete my-1 my-sm-0' type='button' data-bs-target='#modalDeleteGuest' data-bs-toggle='modal'><i id='tr_<?=$g["id"];?>' class='bi-trash-fill'></i></button>
                                </td>
                            </tr>
                        <?php
                                }
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form id="formAddGuest" action="../../controller/controllerGuest.php?act=register-guest" method="POST">
                        ...
                        <div id="divContainCpfResponsableGuest" class="col d-none"></div>
                        <div class="col mb-3">
                        ...
                        <div class="col-12 text-end">
                            <button id="btn_submit" type="submit" class="btn btn-primary">Cadastrar Hóspede</button>
                        </div>
                   </form>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <form id="formEditGuest" action="../../controller/controllerGuest.php?act=edit-guest" method="POST">
                        ...
                        <div class="col-12 text-end">
                            ...
                            <button id="btn_submit" type="submit" class="btn btn-primary">Editar Hóspede</button>
                        </div>
                    </div>
                   </form>
                </div>
