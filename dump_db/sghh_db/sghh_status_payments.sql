...
CREATE TABLE `status_payments` (
  ...
  `status_payment` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `status_payment` (`status_payment`)
...
INSERT INTO `status_payments` VALUES (3,'cancelado'),(1,'pago'),(2,'pendente');
