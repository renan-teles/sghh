...
$typeRoom = filter_input(INPUT_POST, 'type_room', FILTER_VALIDATE_INT);
$typeRoom = $typeRoom ? $typeRoom : 0;

$dailyPriceRoom = filter_input_float($_POST['daily_price_room'] ?? "");

//Create Object 
$room = new Room($numberRoom, $typeRoom, $capacityRoom, $dailyPriceRoom, $floorRoom);
